...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject" do
    assert_difference('Subject.count') do
      post subjects_url, params: { subject: { grade_level: @subject.grade_level, name: @subject.name } }
    end
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { grade_level: @subject.grade_level, name: @subject.name } }
